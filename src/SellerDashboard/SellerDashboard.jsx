...
const SellerDashboard = () => {
  ...
  const [formData,setFormdata] = useState({
    name:"",MobileNumber:"",formType:"",Location:"",Category:"",productName:"",Price:"",Quantity:"",image:""
  })
    ...
    <div className='maindiv'>
      ...
      <Form.Group className="mb-3" controlId="formBasicPassword">
        ...
        <Form.Control as="textarea" rows={2} placeholder="Enter Form Location" onChange={(e)=>setFormdata({...formData,Location:e.target.value})} />
          ...
          <Form.Label>Place Product image</Form.Label>
         <Form.Control type="url" rows={2} placeholder="url" onChange={(e)=>setFormdata({...formData,image:e.target.value})} />
